        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                <div class="navbar-nav">
                    <Link to="/admin/passengerList" class="nav-item nav-link active">All passengers</Link>
                    <Link to="/admin/flightList" class="nav-item nav-link active">All Flights</Link>
